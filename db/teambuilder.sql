...
-- -----------------------------------------------------
-- Table `teambuilder`.`memberstatus`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `teambuilder`.`memberstatus`;
CREATE TABLE IF NOT EXISTS `teambuilder`.`memberstatus`
(
    `id`   INT         NOT NULL AUTO_INCREMENT,
    `slug` VARCHAR(10) NOT NULL,
    `name` VARCHAR(45) NOT NULL,
...
(
    ...
    FOREIGN KEY (status) REFERENCES memberstatus (id),
...
VALUES ("MEM", "Member"),
       ("MOD", "Moderator");
-- -----------------------------------------------------
-- Table `memberstatus` - Data
-- -----------------------------------------------------
INSERT INTO memberstatus(memberstatus.slug, memberstatus.name)
VALUES ("ACT", "Active"),
       ("INA", "Inactive"),
       ("BAN", "Banned");
-- -----------------------------------------------------
